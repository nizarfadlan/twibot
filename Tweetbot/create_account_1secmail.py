    ...
    if check_complete != 'true':
      ...
      if not check_notnow:
        ...
        if check_verification:
          def resend():
            click_object('//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[2]/div[2]/div[1]/div/div[3]/div/div/div/div/span/span')
            time.sleep(2)
            click_object('//*[@id="layers"]/div[2]/div/div/div/div[2]/div[3]/div/div/div/div[2]')
...
def secmail(a,password):
  # ------- READ INPUT FROM CLI -------
  show('Twibot Create Account Email 1secmail by Nizar', 'v1.0.1')
  print()
